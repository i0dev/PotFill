package com.i0dev.plugin.potfill.manager;
...
public class ConfigManager extends AbstractManager {
    ...
    private File getConfigFile(String file) {
        ...
        PotFillPlugin plugin = PotFillPlugin.getPlugin();
        File configFile;
        if (file.contains("/")) {
    ...
    public void prepareFile(String filePath, String resource) {
        ...
        try {
            ...
            if (resource != null && !resource.isEmpty()) {
                this.copyResource(PotFillPlugin.getPlugin().getResource(resource), file);
            }
    ...
    public String getPluginName() {
        return PotFillPlugin.getPlugin().getDescription().getName();
    }
